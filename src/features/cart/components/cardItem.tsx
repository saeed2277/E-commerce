    ...
    <>
      <div className="flex bg-white rounded-lg shadow-md p-4">
        <div className="bg-gray-50 rounded-2xl shadow flex items-center justify-center w-35 h-35">
          <Image src={imageCover} alt={title} height={80} width={80} />
        </div>
        <div className="ml-8 flex flex-col w-full">
          <div className="flex items-start flex-col gap-2">
            ...
            <p className="text-lg font-bold mt-2 text-green-700">{price} EGP</p>
          </div>
          <div className="flex items-center justify-between mt-2">
            ...
            <div className=" ">
              <h3 className="font-semibold text-gray-400 mb-0">Total</h3>
              <div className="flex items-center gap-4 justify-center">
                <p className="text-lg font-bold mt-2 text-green-700">
                  {price * count} EGP
                </p>
                <button
                  className="px-3 py-3 rounded-lg shadow flex items-center justify-center bg-red-100 cursor-pointer text-red-500  hover:bg-red-500 hover:text-white duration-300"
